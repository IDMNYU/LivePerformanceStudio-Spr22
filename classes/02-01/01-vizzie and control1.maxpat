...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 647.400001704692841, 500.000007450580597, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 672.400001704692841, 454.400006771087646, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 647.400001704692841, 652.400001466274261, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 647.400001704692841, 617.066652655601501, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 647.400001704692841, 573.066653370857239, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 647.400001704692841, 421.60000067949295, 69.0, 22.0 ],
					"text" : "route 38 17"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 647.400001704692841, 347.400000631809235, 191.0, 22.0 ],
					"text" : "\"Xbox Wireless Controller\", poll 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "list", "" ],
					"patching_rect" : [ 647.400001704692841, 386.400000631809235, 29.5, 22.0 ],
					"text" : "hi"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 520.000002145767212, 384.800001800060272, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 340.000002145767212, 429.600001811981201, 168.0, 130.0 ],
					"varname" : "mixfadr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 555.000002145767212, 145.800001800060272, 348.0, 158.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 353.0, 3.0, 348.0, 158.0 ],
					"prototypename" : "pixl",
					"varname" : "playr[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 340.000002145767212, 588.800001800060272, 168.0, 108.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 163.0, 168.0, 108.0 ],
					"prototypename" : "pixl",
					"varname" : "projectr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 169.000002145767212, 145.800001800060272, 348.0, 158.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 3.0, 348.0, 158.0 ],
					"prototypename" : "pixl",
					"varname" : "playr",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-1::obj-81" : [ "pictctrl[13]", "pictctrl[1]", 0 ],
			"obj-1::obj-83" : [ "pictctrl[9]", "pictctrl[1]", 0 ],
			"obj-1::obj-89" : [ "moviename[1]", "moviename", 0 ],
			"obj-21::obj-17::obj-23" : [ "gswitch2[5]", "gswitch2", 0 ],
			"obj-21::obj-21" : [ "range[19]", "range", 0 ],
			"obj-21::obj-24" : [ "pictctrl[98]", "pictctrl[1]", 0 ],
